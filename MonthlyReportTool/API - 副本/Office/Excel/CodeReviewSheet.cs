...
namespace MonthlyReportTool.API.Office.Excel
{
    public class CodeReviewSheet : ExcelSheetBase, IExcelSheet
    {
        ...
        {
            Utility.BuildFormalSheetTitle(sheet, 2, "B", 2, "F", "审查工作统计分析");
        }
        ...
        private int BuildTable(int startRow, List<CodeReviewEntity> list)
        {
            ...
            int nextRow = Utility.BuildFormalTable(sheet, startRow, "本迭代审查记录单统计", "", "B", "F",
        ...
        {
            int nextRow = Utility.BuildFormalTable(this.sheet, startRow, "本迭代审查发现问题统计", "说明：", "B", "P",
