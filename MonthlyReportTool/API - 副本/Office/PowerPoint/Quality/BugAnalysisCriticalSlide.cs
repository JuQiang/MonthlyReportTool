...
{
    public class BugAnalysisCriticalSlide : PowerPointSlideBase, IPowerPointQualitySlide
    {
        private PowerPointInterop.Slide slide;
        public BugAnalysisCriticalSlide(PowerPointInterop.Slide slide) : base(slide)
        {
            this.slide = slide;
        }
        public void Build(ProjectEntity project, string yearmonth)
        {
            ...
            subtitle.Text = "1、1、2级Bug原因分析(生产环境)";
