...
namespace MonthlyReportTool.API.Office.Excel
{
    public class WorkReviewSheet : ExcelSheetBase, IExcelSheet
    {
        ...
        public void Build(ProjectEntity project)
        {
            ...
            int startRow = BuildFailedTable(12, this.workReviewList[0]);
            startRow = BuildSuccessTable(startRow, this.workReviewList[1]);//测试通过提交单Bug数统计
            startRow = BuildFailedReasonTable(startRow, this.workReviewList[5]);
            startRow = BuildRemovedReasonTable(startRow, this.workReviewList[2]);
            BuildExceptionTable(startRow, this.workReviewList[1]);
        ...
        private void BuildTestTable()
        {
            ...
            var testpassed = this.workReviewList[1];
            var removed = this.workReviewList[2];
            var all = this.workReviewList[0];
        ...
        private void BuildPerformanceTestTable()
        {
            ...
            sheet.Cells[6, "I"] = this.workReviewList[4].Count;
            sheet.Cells[7, "I"] = this.workReviewList[3].Count;
        ...
        private int BuildFailedTable(int startRow, List<WorkReviewEntity> list)
        {
        ...
        private int BuildSuccessTable(int startRow, List<WorkReviewEntity> list)
        {
        ...
        private int BuildFailedReasonTable(int startRow, List<WorkReviewEntity> list)
        {
        ...
        private int BuildRemovedReasonTable(int startRow, List<WorkReviewEntity> list)
        {
        ...
        private int BuildExceptionTable(int startRow, List<WorkReviewEntity> list)
        {
