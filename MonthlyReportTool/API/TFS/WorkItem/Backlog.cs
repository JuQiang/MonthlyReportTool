...
namespace MonthlyReportTool.API.TFS.WorkItem
{
    public class Backlog
    {
        public static List<List<BacklogEntity>> GetAll(string project, IterationEntity ite)
        {
            ...
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F30本迭代_已提交测试积压工作项总数")));
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F35本迭代_测试通过积压工作项总数")));
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F40本迭代_应提交测试积压工作项总数")));
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F50本迭代_需编写用例积压工作项总数")));
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F60本迭代_实际编写用例积压工作项总数")));
            //list.Add(GetBacklogListByIteration(project, ite, String.Format(Utility.QueryBaseDirectory,"05%20Backlog统计分析%2F65本迭代_编写用例总数")));
